 ...
 * @author Pai
 */
public class purchase_ui_test extends javax.swing.JFrame {
    ...
    public purchase_ui_test(All_Data a1) {
        initComponents();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(purchase_ui_test.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new purchase_ui_test(new All_Data()).setVisible(true);
            }
        });
    }
